...
def create_unified_dataset():
    ...
    # Input CSV paths
    dipd_csv = os.path.join(base_dir, "DIPD", "dipd_financial_data_openai.csv")
    rexp_csv = os.path.join(base_dir, "REXP", "rexp_financial_data_openai.csv")
    ...
    dipd_standardized['Company Type'] = 'DIPD'
    ...
    # Add company identifier column
    rexp_standardized['Company Type'] = 'REXP'
